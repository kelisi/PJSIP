...
pjsip_multipart_create(pj_pool_t *pool,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_multipart_add_part(pj_pool_t *pool,
						 pjsip_msg_body *mp,
						 pjsip_multipart_part *part)
{
...
PJ_DEF(pjsip_msg_body *)
pjsip_multipart_parse(pj_pool_t *pool,
...
PJ_DEF(pj_status_t)
pjsip_multipart_get_raw(pjsip_msg_body *mp,
						pj_str_t *boundary,
						pj_str_t *raw_data)
{
	struct multipart_data *m_data;
