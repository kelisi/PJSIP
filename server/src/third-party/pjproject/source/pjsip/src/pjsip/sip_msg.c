...
PJ_DEF(void)
pjsip_method_set(pjsip_method *m, pjsip_method_e me)
{
...
PJ_DEF(pjsip_msg *)
pjsip_msg_clone(pj_pool_t *pool, const pjsip_msg *src)
{
    pjsip_msg *dst;
    const pjsip_hdr *sh;
...
///////////////////////////////////////////////////////////////////////////////
PJ_DEF(void *)
pjsip_hdr_clone(pj_pool_t *pool, const void *hdr_ptr)
{
...
PJ_DEF(void *)
pjsip_hdr_shallow_clone(pj_pool_t *pool, const void *hdr_ptr)
{
    const pjsip_hdr *hdr = (const pjsip_hdr *)hdr_ptr;
...
PJ_DEF(int)
pjsip_hdr_print_on(void *hdr_ptr, char *buf, pj_size_t len)
{
...
pjsip_get_status_text(int code)
{
...
PJ_DEF(void)
pjsip_generic_string_hdr_init2(pjsip_generic_string_hdr *hdr,
                               pj_str_t *hname,
                               pj_str_t *hvalue)
{
...
{
    char *p = buf;
    const pj_str_t *hname = pjsip_cfg()->endpt.use_compact_form ? &hdr->sname : &hdr->name;
...
pjsip_max_fwd_hdr_init(pj_pool_t *pool,
                       void *mem,
                       int value)
{
...
PJ_DEF(pjsip_max_fwd_hdr *)
pjsip_max_fwd_hdr_create(pj_pool_t *pool,
                         int value)
{
...
PJ_DEF(pjsip_rr_hdr *)
pjsip_routing_hdr_set_rr(pjsip_routing_hdr *hdr)
{
...
PJ_DEF(pjsip_route_hdr *)
pjsip_routing_hdr_set_route(pjsip_routing_hdr *hdr)
{
