...
PJ_DEF(pj_bool_t)
pjsip_method_creates_dialog(const pjsip_method *m)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_create_uac(pjsip_user_agent *ua,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_create_uas(pjsip_user_agent *ua,
                     pjsip_rx_data *rdata,
                     const pj_str_t *contact,
                     pjsip_dialog **p_dlg)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_set_transport(pjsip_dialog *dlg,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_set_via_sent_by(pjsip_dialog *dlg,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_fork(const pjsip_dialog *first_dlg,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_terminate(pjsip_dialog *dlg)
{
    /* Number of sessions must be zero. */
    PJ_ASSERT_RETURN(dlg->sess_count == 0, PJ_EINVALIDOP);
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_set_route_set(pjsip_dialog *dlg,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_inc_session(pjsip_dialog *dlg,
                      pjsip_module *mod)
{
 ...
 */
PJ_DEF(void)
pjsip_dlg_inc_lock(pjsip_dialog *dlg)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_try_inc_lock(pjsip_dialog *dlg)
{
    pj_status_t status;
 ...
 */
PJ_DEF(void)
pjsip_dlg_dec_lock(pjsip_dialog *dlg)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_dec_session(pjsip_dialog *dlg,
                      pjsip_module *mod)
{
    PJ_ASSERT_RETURN(dlg, PJ_EINVAL);
 ...
 */
PJ_DEF(pj_bool_t)
pjsip_dlg_has_usage(pjsip_dialog *dlg,
                    pjsip_module *mod)
{
    unsigned index;
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_add_usage(pjsip_dialog *dlg,
                    pjsip_module *mod,
                    void *mod_data)
{
    unsigned index;
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_set_mod_data(pjsip_dialog *dlg,
                       int mod_id,
                       void *data)
{
    PJ_ASSERT_RETURN(dlg, PJ_EINVAL);
 ...
 */
PJ_DEF(void *)
pjsip_dlg_get_mod_data(pjsip_dialog *dlg,
                       int mod_id)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_create_request(pjsip_dialog *dlg,
                         const pjsip_method *method,
                         int cseq,
                         pjsip_tx_data **p_tdata)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_send_request(pjsip_dialog *dlg,
                       pjsip_tx_data *tdata,
                       int mod_data_id,
                       void *mod_data)
{
                                  ...
                                  pjsip_tx_data *tdata)
{
    ...
    if (add_headers && pjsip_method_creates_dialog(&cseq->method))
    {
        ...
        if ((((st_code / 10 == 18 || st_class == 2) && dlg->add_allow) || st_code == 405) &&
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_create_response(pjsip_dialog *dlg,
                          pjsip_rx_data *rdata,
                          int st_code,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_modify_response(pjsip_dialog *dlg,
                          pjsip_tx_data *tdata,
                          int st_code,
                          const pj_str_t *st_text)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_send_response(pjsip_dialog *dlg,
                        pjsip_transaction *tsx,
                        pjsip_tx_data *tdata)
{
    pj_status_t status;
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_respond(pjsip_dialog *dlg,
                  pjsip_rx_data *rdata,
                  int st_code,
                  const pj_str_t *st_text,
...
void pjsip_dlg_on_rx_request(pjsip_dialog *dlg, pjsip_rx_data *rdata)
{
    ...
    PJ_LOG(5, (THIS_FILE, "[sp][ua][dialog][request] dialog->obj_name:%s received:%s", dlg->obj_name, pjsip_rx_data_get_info(rdata)));
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_update_remote_cap(pjsip_dialog *dlg,
                            const pjsip_msg *msg,
                            pj_bool_t strict)
{
    pjsip_hdr_e htypes[] =
...
pjsip_dlg_get_remote_cap_hdr(pjsip_dialog *dlg,
                             int htype,
                             const pj_str_t *hname)
{
    pjsip_hdr *hdr;
 ...
 */
PJ_DEF(pj_status_t)
pjsip_dlg_remove_remote_cap_hdr(pjsip_dialog *dlg,
                                int htype,
                                const pj_str_t *hname)
{
    pjsip_generic_array_hdr *hdr;
