...
PJ_DEF(pj_status_t)
pjsip_target_set_add_uri(pjsip_target_set *tset,
						 pj_pool_t *pool,
						 const pjsip_uri *uri,
						 int q1000)
{
...
PJ_DEF(pj_status_t)
pjsip_target_set_add_from_msg(pjsip_target_set *tset,
							  pj_pool_t *pool,
							  const pjsip_msg *msg)
{
	const pjsip_hdr *hdr;
...
/* Set current target */
PJ_DEF(pj_status_t)
pjsip_target_set_set_current(pjsip_target_set *tset,
							 pjsip_target *target)
{
...
PJ_DEF(pj_status_t)
pjsip_target_assign_status(pjsip_target *target,
						   pj_pool_t *pool,
						   int status_code,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_create_request(pjsip_endpoint *endpt,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_create_response(pjsip_endpoint *endpt,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_create_ack(pjsip_endpoint *endpt,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_create_cancel(pjsip_endpoint *endpt,
...
PJ_DEF(pj_status_t)
pjsip_get_dest_info(const pjsip_uri *target_uri,
					...
					pjsip_host_info *dest_info)
{
	...
	{
		dest_info->type = (pjsip_transport_type_e)((int)dest_info->type | PJSIP_TRANSPORT_IPV6);
	}
 ...
 */
PJ_DEF(pj_status_t)
pjsip_get_request_dest(const pjsip_tx_data *tdata,
					   pjsip_host_info *dest_info)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_process_route_set(pjsip_tx_data *tdata,
						pjsip_host_info *dest_info)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_send_raw(pjsip_endpoint *endpt,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_send_raw_to_uri(pjsip_endpoint *endpt,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_get_response_addr(pj_pool_t *pool,
						pjsip_rx_data *rdata,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_send_response(pjsip_endpoint *endpt,
						  pjsip_response_addr *res_addr,
						  pjsip_tx_data *tdata,
						  void *token,
						  pjsip_send_callback cb)
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_send_response2(pjsip_endpoint *endpt,
						   pjsip_rx_data *rdata,
						   pjsip_tx_data *tdata,
						   void *token,
						   pjsip_send_callback cb)
 ...
 */
PJ_DEF(pj_status_t)
pjsip_endpt_respond_stateless(pjsip_endpoint *endpt,
							  pjsip_rx_data *rdata,
							  int st_code,
							  const pj_str_t *st_text,
 ...
 */
PJ_DEF(const char *)
pjsip_event_str(pjsip_event_id_e e)
{
	return event_str[e];
}
