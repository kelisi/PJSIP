...
PJ_DECL_DATA(const pjsip_method)
pjsip_invite_method;
...
PJ_DECL(const pjsip_method *)
pjsip_get_invite_method(void);
/** Get CANCEL method constant. */
PJ_DECL(const pjsip_method *)
pjsip_get_cancel_method(void);
/** Get ACK method constant. */
PJ_DECL(const pjsip_method *)
pjsip_get_ack_method(void);
/** Get BYE method constant. */
PJ_DECL(const pjsip_method *)
pjsip_get_bye_method(void);
/** Get REGISTER method constant.*/
PJ_DECL(const pjsip_method *)
pjsip_get_register_method(void);
/** Get OPTIONS method constant. */
PJ_DECL(const pjsip_method *)
pjsip_get_options_method(void);
 ...
 */
PJ_DECL(void)
pjsip_method_init(pjsip_method *m,
                  pj_pool_t *pool,
                  const pj_str_t *str);
 ...
 */
PJ_DECL(void)
pjsip_method_init_np(pjsip_method *m,
                     pj_str_t *str);
 ...
 */
PJ_DECL(void)
pjsip_method_set(pjsip_method *m, pjsip_method_e id);
 ...
 */
PJ_DECL(void)
pjsip_method_copy(pj_pool_t *pool,
                  pjsip_method *method,
 ...
 */
PJ_DECL(int)
pjsip_method_cmp(const pjsip_method *m1, const pjsip_method *m2);
 ...
 */
PJ_DECL(void *)
pjsip_hdr_clone(pj_pool_t *pool, const void *hdr);
 ...
 */
PJ_DECL(void *)
pjsip_hdr_shallow_clone(pj_pool_t *pool, const void *hdr);
 ...
 */
PJ_DECL(int)
pjsip_hdr_print_on(void *hdr, char *buf, pj_size_t len);
...
pjsip_get_status_text(int status_code);
 ...
 */
PJ_DECL(void)
pjsip_media_type_init(pjsip_media_type *mt,
                      pj_str_t *type,
                      pj_str_t *subtype);
 ...
 */
PJ_DECL(void)
pjsip_media_type_init2(pjsip_media_type *mt,
                       char *type,
                       char *subtype);
 ...
 */
PJ_DECL(int)
pjsip_media_type_cmp(const pjsip_media_type *mt1,
 ...
 */
PJ_DECL(void)
pjsip_media_type_cp(pj_pool_t *pool,
 ...
 */
PJ_DECL(int)
pjsip_media_type_print(char *buf, unsigned len,
 ...
 */
PJ_DECL(int)
pjsip_print_text_body(pjsip_msg_body *msg_body,
                      char *buf, pj_size_t size);
 ...
 */
PJ_DECL(void *)
pjsip_clone_text_data(pj_pool_t *pool, const void *data,
                      unsigned len);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_msg_body_copy(pj_pool_t *pool,
...
pjsip_msg_body_clone(pj_pool_t *pool,
 ...
 */
PJ_DECL(pjsip_msg_body *)
pjsip_msg_body_create(pj_pool_t *pool,
                      const pj_str_t *type,
 ...
 */
PJ_DECL(pjsip_msg *)
pjsip_msg_create(pj_pool_t *pool, pjsip_msg_type_e type);
 ...
 */
PJ_DECL(pjsip_msg *)
pjsip_msg_clone(pj_pool_t *pool, const pjsip_msg *msg);
 ...
 */
PJ_DECL(void *)
pjsip_msg_find_hdr(const pjsip_msg *msg,
 ...
 */
PJ_DECL(void *)
pjsip_msg_find_hdr_by_name(const pjsip_msg *msg,
                           const pj_str_t *name,
                           const void *start);
 ...
 */
PJ_DECL(void *)
pjsip_msg_find_hdr_by_names(const pjsip_msg *msg,
                            const pj_str_t *name,
 ...
 */
PJ_DECL(void *)
pjsip_msg_find_remove_hdr(pjsip_msg *msg,
 ...
 */
PJ_INLINE(void)
pjsip_msg_add_hdr(pjsip_msg *msg, pjsip_hdr *hdr)
{
 ...
 */
PJ_INLINE(void)
pjsip_msg_insert_first_hdr(pjsip_msg *msg, pjsip_hdr *hdr)
{
 ...
 */
PJ_DECL(pj_ssize_t)
pjsip_msg_print(const pjsip_msg *msg,
                char *buf, pj_size_t size);
 ...
 */
PJ_DECL(void)
pjsip_generic_string_hdr_init2(pjsip_generic_string_hdr *h,
                               pj_str_t *hname,
                               pj_str_t *hvalue);
...
pjsip_generic_int_hdr_create(pj_pool_t *pool,
                             const pj_str_t *hname,
                             int hvalue);
 ...
 */
PJ_DECL(pjsip_generic_int_hdr *)
pjsip_generic_int_hdr_init(pj_pool_t *pool,
                           void *mem,
                           const pj_str_t *hname,
                           int value);
...
pjsip_generic_array_hdr_create(pj_pool_t *pool,
                               const pj_str_t *hname);
 ...
 */
PJ_DECL(pjsip_generic_array_hdr *)
pjsip_generic_array_hdr_init(pj_pool_t *pool,
                             void *mem,
                             const pj_str_t *hname);
 ...
 */
PJ_DECL(pjsip_accept_hdr *)
pjsip_accept_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_accept_hdr *)
pjsip_accept_hdr_init(pj_pool_t *pool,
                      void *mem);
 ...
 */
PJ_DECL(pjsip_allow_hdr *)
pjsip_allow_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_allow_hdr *)
pjsip_allow_hdr_init(pj_pool_t *pool,
                     void *mem);
 ...
 */
PJ_DECL(pjsip_cid_hdr *)
pjsip_cid_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_cid_hdr *)
pjsip_cid_hdr_init(pj_pool_t *pool,
                   void *mem);
 ...
 */
PJ_DECL(pjsip_clen_hdr *)
pjsip_clen_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_clen_hdr *)
pjsip_clen_hdr_init(pj_pool_t *pool,
                    void *mem);
 ...
 */
PJ_DECL(pjsip_cseq_hdr *)
pjsip_cseq_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_cseq_hdr *)
pjsip_cseq_hdr_init(pj_pool_t *pool,
                    void *mem);
 ...
 */
PJ_DECL(pjsip_contact_hdr *)
pjsip_contact_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_contact_hdr *)
pjsip_contact_hdr_init(pj_pool_t *pool,
                       void *mem);
 ...
 */
PJ_DECL(pjsip_ctype_hdr *)
pjsip_ctype_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_ctype_hdr *)
pjsip_ctype_hdr_init(pj_pool_t *pool,
                     void *mem);
...
pjsip_expires_hdr_create(pj_pool_t *pool,
                         int value);
 ...
 */
PJ_DECL(pjsip_expires_hdr *)
pjsip_expires_hdr_init(pj_pool_t *pool,
                       void *mem,
                       int value);
 ...
 */
PJ_DECL(pjsip_from_hdr *)
pjsip_from_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_from_hdr *)
pjsip_from_hdr_init(pj_pool_t *pool,
                    void *mem);
 ...
 */
PJ_DECL(pjsip_to_hdr *)
pjsip_to_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_to_hdr *)
pjsip_to_hdr_init(pj_pool_t *pool,
                  void *mem);
 ...
 */
PJ_DECL(pjsip_from_hdr *)
pjsip_fromto_hdr_set_from(pjsip_fromto_hdr *hdr);
 ...
 */
PJ_DECL(pjsip_to_hdr *)
pjsip_fromto_hdr_set_to(pjsip_fromto_hdr *hdr);
...
pjsip_min_expires_hdr_create(pj_pool_t *pool,
                             int value);
 ...
 */
PJ_DECL(pjsip_min_expires_hdr *)
pjsip_min_expires_hdr_init(pj_pool_t *pool,
                           void *mem,
                           int value);
 ...
 */
PJ_DECL(pjsip_rr_hdr *)
pjsip_rr_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_rr_hdr *)
pjsip_rr_hdr_init(pj_pool_t *pool,
                  void *mem);
 ...
 */
PJ_DECL(pjsip_route_hdr *)
pjsip_route_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_route_hdr *)
pjsip_route_hdr_init(pj_pool_t *pool,
                     void *mem);
 ...
 */
PJ_DECL(pjsip_rr_hdr *)
pjsip_routing_hdr_set_rr(pjsip_routing_hdr *r);
 ...
 */
PJ_DECL(pjsip_route_hdr *)
pjsip_routing_hdr_set_route(pjsip_routing_hdr *r);
 ...
 */
PJ_DECL(pjsip_require_hdr *)
pjsip_require_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_require_hdr *)
pjsip_require_hdr_init(pj_pool_t *pool,
                       void *mem);
...
pjsip_retry_after_hdr_create(pj_pool_t *pool,
                             int value);
 ...
 */
PJ_DECL(pjsip_retry_after_hdr *)
pjsip_retry_after_hdr_init(pj_pool_t *pool,
                           void *mem,
                           int value);
...
pjsip_supported_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_supported_hdr *)
pjsip_supported_hdr_init(pj_pool_t *pool,
                         void *mem);
...
pjsip_unsupported_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_unsupported_hdr *)
pjsip_unsupported_hdr_init(pj_pool_t *pool,
                           void *mem);
 ...
 */
PJ_DECL(pjsip_via_hdr *)
pjsip_via_hdr_create(pj_pool_t *pool);
 ...
 */
PJ_DECL(pjsip_via_hdr *)
pjsip_via_hdr_init(pj_pool_t *pool,
                   void *mem);
...
pjsip_warning_hdr_create(pj_pool_t *pool,
                         int code,
                         const pj_str_t *host,
                         const pj_str_t *text);
