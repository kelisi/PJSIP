export PJDIR := /Users/chirpin-2/Documents/PJSIP/Code/Smotalk/server/src/third-party/pjproject/source
...
export CC_NAME := gcc
export TARGET_ARCH := 
export TARGET_NAME := x86_64-apple-darwin16.7.0
...
# FFMPEG flags
FFMPEG_CFLAGS =  -DPJMEDIA_HAS_LIBAVDEVICE=1 -DPJMEDIA_HAS_LIBAVFORMAT=1 -DPJMEDIA_HAS_LIBAVCODEC=1 -DPJMEDIA_HAS_LIBSWSCALE=1 -DPJMEDIA_HAS_LIBAVUTIL=1 -I/usr/local/Cellar/ffmpeg/4.1.4_1/include 
FFMPEG_LDFLAGS =   -L/usr/local/Cellar/ffmpeg/4.1.4_1/lib -lavdevice -lavformat -lavcodec -lswscale -lavutil
...
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	 -O3 -DNDEBUG -msoft-float -fno-builtin -g -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
	$(PJ_VIDEO_CFLAGS) \
...
export APP_CXXFLAGS := -g $(APP_CFLAGS)
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1  -O3 -DNDEBUG -msoft-float -fno-builtin -g -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
export PJ_INSTALL_CXXFLAGS := -g $(PJ_INSTALL_CFLAGS)
