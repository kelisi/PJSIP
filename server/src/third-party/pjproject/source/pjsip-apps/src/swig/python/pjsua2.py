...
PJMEDIA_AUD_DEFAULT_CAPTURE_DEV = _pjsua2.PJMEDIA_AUD_DEFAULT_CAPTURE_DEV
PJMEDIA_AUD_DEFAULT_PLAYBACK_DEV = _pjsua2.PJMEDIA_AUD_DEFAULT_PLAYBACK_DEV
PJMEDIA_AUD_INVALID_DEV = _pjsua2.PJMEDIA_AUD_INVALID_DEV
...
class MediaFormatVector(_object):
    ...
    def iterator(self):
        return _pjsua2.MediaFormatVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _pjsua2.MediaFormatVector___nonzero__(self)

    def __bool__(self):
        return _pjsua2.MediaFormatVector___bool__(self)

    def __len__(self):
        return _pjsua2.MediaFormatVector___len__(self)

    def __getslice__(self, i, j):
        return _pjsua2.MediaFormatVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _pjsua2.MediaFormatVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _pjsua2.MediaFormatVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _pjsua2.MediaFormatVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _pjsua2.MediaFormatVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _pjsua2.MediaFormatVector___setitem__(self, *args)

    def pop(self):
        return _pjsua2.MediaFormatVector_pop(self)

    def append(self, x):
        return _pjsua2.MediaFormatVector_append(self, x)

    def empty(self):
        return _pjsua2.MediaFormatVector_empty(self)

    def size(self):
        return _pjsua2.MediaFormatVector_size(self)

    def swap(self, v):
        return _pjsua2.MediaFormatVector_swap(self, v)

    def begin(self):
        return _pjsua2.MediaFormatVector_begin(self)

    def end(self):
        return _pjsua2.MediaFormatVector_end(self)

    def rbegin(self):
        return _pjsua2.MediaFormatVector_rbegin(self)

    def rend(self):
        return _pjsua2.MediaFormatVector_rend(self)

    def clear(self):
        return _pjsua2.MediaFormatVector_clear(self)

    def get_allocator(self):
        return _pjsua2.MediaFormatVector_get_allocator(self)

    def pop_back(self):
        return _pjsua2.MediaFormatVector_pop_back(self)

    def erase(self, *args):
        return _pjsua2.MediaFormatVector_erase(self, *args)
    ...
    def push_back(self, x):
        return _pjsua2.MediaFormatVector_push_back(self, x)

    def front(self):
        return _pjsua2.MediaFormatVector_front(self)

    def back(self):
        return _pjsua2.MediaFormatVector_back(self)

    def assign(self, n, x):
        return _pjsua2.MediaFormatVector_assign(self, n, x)

    def resize(self, *args):
        return _pjsua2.MediaFormatVector_resize(self, *args)

    def insert(self, *args):
        return _pjsua2.MediaFormatVector_insert(self, *args)

    def reserve(self, n):
        return _pjsua2.MediaFormatVector_reserve(self, n)

    def capacity(self):
        return _pjsua2.MediaFormatVector_capacity(self)
...
class OnCallRxReinviteParam(_object):
    ...
    __swig_setmethods__["async"] = _pjsua2.OnCallRxReinviteParam_async_set
    __swig_getmethods__["async"] = _pjsua2.OnCallRxReinviteParam_async_get
    if _newclass:
