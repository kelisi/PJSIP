                                  ...
                                  const pj_timestamp *stop)
{
    ...
    /*TODO: WHY??? usec = elapsed * MSEC / freq */
...
PJ_DEF(pj_uint32_t)
pj_elapsed_nanosec(const pj_timestamp *start,
                   const pj_timestamp *stop)
{
    pj_timestamp ts_freq;
    pj_highprec_t freq, elapsed;
...
PJ_DEF(pj_uint32_t)
pj_elapsed_usec(const pj_timestamp *start,
                const pj_timestamp *stop)
{
...
PJ_DEF(pj_uint32_t)
pj_elapsed_msec(const pj_timestamp *start,
                const pj_timestamp *stop)
{
...
PJ_DEF(pj_uint64_t)
pj_elapsed_msec64(const pj_timestamp *start,
                  const pj_timestamp *stop)
{
...
PJ_DEF(pj_time_val)
pj_elapsed_time(const pj_timestamp *start,
                const pj_timestamp *stop)
{
...
PJ_DEF(pj_uint32_t)
pj_elapsed_cycle(const pj_timestamp *start,
                 const pj_timestamp *stop)
{
...
PJ_DEF(pj_status_t)
pj_gettickcount(pj_time_val *tv)
{
