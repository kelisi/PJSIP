...
PJ_DEF(pj_status_t)
pj_qos_get_params(pj_qos_type type,
...
PJ_DEF(pj_status_t)
pj_qos_get_type(const pj_qos_params *param,
				pj_qos_type *p_type)
{
...
/* Apply QoS */
PJ_DEF(pj_status_t)
pj_sock_apply_qos(pj_sock_t sock,
...
{
	PJ_LOG(3, (THIS_FILE, "[qos] Apply QoS type:%d to socket:%s", qos_type, sock_name));
...
PJ_DEF(pj_status_t)
pj_sock_apply_qos2(pj_sock_t sock,
				   pj_qos_type qos_type,
