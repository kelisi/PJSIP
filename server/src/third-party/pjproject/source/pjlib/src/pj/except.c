...
PJ_DEF(void)
pj_throw_exception_(int exception_id)
{
...
PJ_DEF(void)
pj_push_exception_handler_(struct pj_exception_state_t *rec)
{
...
PJ_DEF(void)
pj_pop_exception_handler_(struct pj_exception_state_t *rec)
{
    struct pj_exception_state_t *handler;
...
#if defined(PJ_HAS_EXCEPTION_NAMES) && PJ_HAS_EXCEPTION_NAMES != 0
PJ_DEF(pj_status_t)
pj_exception_id_alloc(const char *name,
...
PJ_DEF(pj_status_t)
pj_exception_id_free(pj_exception_id_t id)
{
    /*
     * Start from 1 (not 0)!!!
     * Exception 0 is reserved for normal path of setjmp()!!!
...
PJ_DEF(const char *)
pj_exception_id_name(pj_exception_id_t id)
{
