...
pj_status_t pj_log_init(void)
{
	...
	if (thread_suspended_tls_id == -1)
	{
		...
		if (status != PJ_SUCCESS)
			return status;
		// #### Modify BY MSS ####
		PJ_LOG(3, (THIS_FILE, "[log]thread_suspended_tls_id ret == %ld", thread_suspended_tls_id));
#if PJ_LOG_ENABLE_INDENT
...
PJ_DEF(void)
pj_log_set_decor(unsigned decor)
{
	log_decor = decor;
}

PJ_DEF(unsigned)
pj_log_get_decor(void)
{
	return log_decor;
}
...
PJ_DEF(void)
pj_log_set_log_func(pj_log_func *func)
{
	log_writer = func;
}
...
PJ_DEF(void)
pj_log(const char *sender, int level,
...
PJ_DEF(void)
pj_log_1(const char *obj, const char *format, ...)
{
	va_list arg;
	va_start(arg, format);
...
PJ_DEF(void)
pj_log_2(const char *obj, const char *format, ...)
{
	va_list arg;
	va_start(arg, format);
...
PJ_DEF(void)
pj_log_3(const char *obj, const char *format, ...)
{
	va_list arg;
	va_start(arg, format);
...
PJ_DEF(void)
pj_log_4(const char *obj, const char *format, ...)
{
	va_list arg;
	va_start(arg, format);
...
PJ_DEF(void)
pj_log_5(const char *obj, const char *format, ...)
{
	va_list arg;
	va_start(arg, format);
...
PJ_DEF(void)
pj_log_6(const char *obj, const char *format, ...)
{
	va_list arg;
	va_start(arg, format);
