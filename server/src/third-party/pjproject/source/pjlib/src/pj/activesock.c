...
PJ_DEF(void)
pj_activesock_set_iphone_os_bg(pj_activesock_t *asock,
							   int val)
{
...
PJ_DEF(void)
pj_activesock_enable_iphone_os_bg(pj_bool_t val)
{
	ios_bg_support = val;
}
#endif
...
PJ_DEF(pj_status_t)
pj_activesock_create(pj_pool_t *pool,
					 pj_sock_t sock,
					 int sock_type,
...
PJ_DEF(pj_status_t)
pj_activesock_create_udp(pj_pool_t *pool,
...
PJ_DEF(pj_status_t)
pj_activesock_set_user_data(pj_activesock_t *asock,
							void *user_data)
{
	PJ_ASSERT_RETURN(asock, PJ_EINVAL);
	asock->user_data = user_data;
...
PJ_DEF(pj_status_t)
pj_activesock_start_read(pj_activesock_t *asock,
						 pj_pool_t *pool,
						 unsigned buff_size,
						 pj_uint32_t flags)
{
...
PJ_DEF(pj_status_t)
pj_activesock_start_read2(pj_activesock_t *asock,
						  pj_pool_t *pool,
						  unsigned buff_size,
						  void *readbuf[],
						  pj_uint32_t flags)
...
PJ_DEF(pj_status_t)
pj_activesock_start_recvfrom(pj_activesock_t *asock,
							 pj_pool_t *pool,
							 unsigned buff_size,
							 pj_uint32_t flags)
{
...
PJ_DEF(pj_status_t)
pj_activesock_start_recvfrom2(pj_activesock_t *asock,
							  pj_pool_t *pool,
							  unsigned buff_size,
							  void *readbuf[],
							  pj_uint32_t flags)
...
PJ_DEF(pj_status_t)
pj_activesock_send(pj_activesock_t *asock,
				   pj_ioqueue_op_key_t *send_key,
				   const void *data,
				   pj_ssize_t *size,
				   unsigned flags)
...
PJ_DEF(pj_status_t)
pj_activesock_sendto(pj_activesock_t *asock,
					 pj_ioqueue_op_key_t *send_key,
					 const void *data,
					 pj_ssize_t *size,
					 unsigned flags,
...
#if PJ_HAS_TCP
PJ_DEF(pj_status_t)
pj_activesock_start_accept(pj_activesock_t *asock,
						   pj_pool_t *pool)
{
	unsigned i;
...
PJ_DEF(pj_status_t)
pj_activesock_start_connect(pj_activesock_t *asock,
							pj_pool_t *pool,
