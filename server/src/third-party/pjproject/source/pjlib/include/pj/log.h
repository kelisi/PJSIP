 ...
 */
PJ_DECL(void)
pj_log_write(int level, const char *buffer, int len);
...
/** Internal function. */
PJ_DECL(void)
pj_log_1(const char *src, const char *format, ...);
#else
...
/** Internal function. */
PJ_DECL(void)
pj_log_2(const char *src, const char *format, ...);
#else
...
/** Internal function. */
PJ_DECL(void)
pj_log_3(const char *src, const char *format, ...);
#else
...
/** Internal function. */
PJ_DECL(void)
pj_log_4(const char *src, const char *format, ...);
#else
...
/** Internal function. */
PJ_DECL(void)
pj_log_5(const char *src, const char *format, ...);
#else
...
/** Internal function. */
PJ_DECL(void)
pj_log_6(const char *src, const char *format, ...);
#else
