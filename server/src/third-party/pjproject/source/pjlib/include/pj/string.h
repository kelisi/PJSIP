 ...
 * @return	pj_str_t.
 */
PJ_INLINE(const pj_str_t *)
pj_cstr(pj_str_t *str, const char *s)
{
    str->ptr = (char *)s;
 ...
 */
PJ_INLINE(pj_str_t *)
pj_strset(pj_str_t *str, char *ptr, pj_size_t length)
{
    str->ptr = ptr;
 ...
 */
PJ_INLINE(pj_str_t *)
pj_strset2(pj_str_t *str, char *src)
{
    str->ptr = src;
 ...
 */
PJ_INLINE(pj_str_t *)
pj_strset3(pj_str_t *str, char *begin, char *end)
{
    str->ptr = begin;
 ...
 */
PJ_IDECL(pj_str_t *)
pj_strassign(pj_str_t *dst, pj_str_t *src);
 ...
 */
PJ_IDECL(pj_str_t *)
pj_strcpy(pj_str_t *dst, const pj_str_t *src);
 ...
 */
PJ_IDECL(pj_str_t *)
pj_strcpy2(pj_str_t *dst, const char *src);
 ...
 */
PJ_IDECL(pj_str_t *)
pj_strncpy(pj_str_t *dst, const pj_str_t *src,
           pj_ssize_t max);
 ...
 */
PJ_IDECL(pj_str_t *)
pj_strncpy_with_null(pj_str_t *dst, const pj_str_t *src,
                     pj_ssize_t max);
 ...
 */
PJ_IDECL(pj_str_t *)
pj_strdup_with_null(pj_pool_t *pool,
                    pj_str_t *dst,
                    const pj_str_t *src);
 ...
 */
PJ_IDECL(pj_str_t)
pj_strdup3(pj_pool_t *pool, const char *src);
 ...
 */
PJ_INLINE(const char *)
pj_strbuf(const pj_str_t *str)
{
    return str->ptr;
}
 ...
 */
PJ_IDECL(int)
pj_strcmp(const pj_str_t *str1, const pj_str_t *str2);
 ...
 */
PJ_IDECL(int)
pj_strcmp2(const pj_str_t *str1, const char *str2);
 ...
 */
PJ_IDECL(int)
pj_strncmp(const pj_str_t *str1, const pj_str_t *str2,
           pj_size_t len);
 ...
 */
PJ_IDECL(int)
pj_strncmp2(const pj_str_t *str1, const char *str2,
            pj_size_t len);
 ...
 */
PJ_IDECL(int)
pj_stricmp(const pj_str_t *str1, const pj_str_t *str2);
...
PJ_IDECL(int)
strnicmp_alnum(const char *str1, const char *str2,
               int len);
#else
...
#if defined(PJ_HAS_STRICMP_ALNUM) && PJ_HAS_STRICMP_ALNUM != 0
PJ_IDECL(int)
pj_stricmp_alnum(const pj_str_t *str1, const pj_str_t *str2);
#else
 ...
 */
PJ_IDECL(int)
pj_stricmp2(const pj_str_t *str1, const char *str2);
 ...
 */
PJ_IDECL(int)
pj_strnicmp(const pj_str_t *str1, const pj_str_t *str2,
            pj_size_t len);
 ...
 */
PJ_IDECL(int)
pj_strnicmp2(const pj_str_t *str1, const char *str2,
             pj_size_t len);
 ...
 */
PJ_IDECL(void)
pj_strcat(pj_str_t *dst, const pj_str_t *src);
 ...
 */
PJ_IDECL(void)
pj_strcat2(pj_str_t *dst, const char *src);
 ...
 */
PJ_INLINE(char *)
pj_strchr(const pj_str_t *str, int chr)
{
    if (str->slen == 0)
        return NULL;
 ...
 */
PJ_DECL(pj_ssize_t)
pj_strspn(const pj_str_t *str, const pj_str_t *set_char);
 ...
 */
PJ_DECL(pj_ssize_t)
pj_strspn2(const pj_str_t *str, const char *set_char);
 ...
 */
PJ_DECL(pj_ssize_t)
pj_strcspn(const pj_str_t *str, const pj_str_t *set_char);
 ...
 */
PJ_DECL(pj_ssize_t)
pj_strcspn2(const pj_str_t *str, const char *set_char);
 ...
 */
PJ_DECL(pj_ssize_t)
pj_strtok(const pj_str_t *str, const pj_str_t *delim,
 ...
 */
PJ_DECL(pj_ssize_t)
pj_strtok2(const pj_str_t *str, const char *delim,
           pj_str_t *tok, pj_size_t start_idx);
 ...
 */
PJ_DECL(char *)
pj_strstr(const pj_str_t *str, const pj_str_t *substr);
 ...
 */
PJ_DECL(char *)
pj_stristr(const pj_str_t *str, const pj_str_t *substr);
 ...
 */
PJ_DECL(char *)
pj_create_random_string(char *str, pj_size_t length);
 ...
 */
PJ_DECL(pj_status_t)
pj_strtol2(const pj_str_t *str, long *value);
 ...
 */
PJ_DECL(unsigned long)
pj_strtoul2(const pj_str_t *str, pj_str_t *endptr,
            unsigned base);
 ...
 */
PJ_DECL(pj_status_t)
pj_strtoul3(const pj_str_t *str, unsigned long *value,
            unsigned base);
 ...
 */
PJ_DECL(int)
pj_utoa(unsigned long val, char *buf);
 ...
 */
PJ_DECL(int)
pj_utoa_pad(unsigned long val, char *buf, int min_dig, int pad);

PJ_DECL(char *)
pj_itoa(int num, char *ret, int radix);
 ...
 */
PJ_INLINE(void)
pj_bzero(void *dst, pj_size_t size)
{
 ...
 */
PJ_INLINE(void *)
pj_memset(void *dst, int c, pj_size_t size)
{
 ...
 */
PJ_INLINE(void *)
pj_memcpy(void *dst, const void *src, pj_size_t size)
{
 ...
 */
PJ_INLINE(void *)
pj_memmove(void *dst, const void *src, pj_size_t size)
{
 ...
 */
PJ_INLINE(int)
pj_memcmp(const void *buf1, const void *buf2, pj_size_t size)
{
 ...
 */
PJ_INLINE(void *)
pj_memchr(const void *buf, int c, pj_size_t size)
{
