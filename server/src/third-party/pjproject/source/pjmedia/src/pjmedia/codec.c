 ...
 */
PJ_DEF(pj_status_t)
pjmedia_codec_mgr_init(pjmedia_codec_mgr *mgr,
                       pj_pool_factory *pf)
{
    pj_status_t status;
 ...
 */
PJ_DEF(pj_status_t)
pjmedia_codec_mgr_destroy(pjmedia_codec_mgr *mgr)
{
 ...
 */
PJ_DEF(char *)
pjmedia_codec_info_to_id(const pjmedia_codec_info *info,
 ...
 */
PJ_DEF(pj_status_t)
pjmedia_codec_mgr_dealloc_codec(pjmedia_codec_mgr *mgr,
                                pjmedia_codec *codec)
{
