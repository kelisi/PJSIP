 ...
 */
PJ_DEF(pj_status_t)
pjmedia_vid_codec_mgr_destroy(pjmedia_vid_codec_mgr *mgr)
{
    if (!mgr)
...
PJ_DEF(pjmedia_vid_codec_mgr *)
pjmedia_vid_codec_mgr_instance(void)
{
...
PJ_DEF(void)
pjmedia_vid_codec_mgr_set_instance(pjmedia_vid_codec_mgr *mgr)
{
    def_vid_codec_mgr = mgr;
}
 ...
 */
PJ_DEF(pj_status_t)
pjmedia_vid_codec_mgr_register_factory(
    pjmedia_vid_codec_mgr *mgr,
    pjmedia_vid_codec_factory *factory)
{
    ...
    for (i = 0; i < count; ++i)
    {
        ...
        PJ_LOG(3, (THIS_FILE, "[video][codec]register codec:[%s] to manager.", mgr->codec_desc[mgr->codec_cnt + i].id));
    }
 ...
 */
PJ_DEF(pj_status_t)
pjmedia_vid_codec_mgr_unregister_factory(
    pjmedia_vid_codec_mgr *mgr,
    pjmedia_vid_codec_factory *factory)
{
    unsigned i;
 ...
 */
PJ_DEF(pj_status_t)
pjmedia_vid_codec_mgr_get_codec_info(
    pjmedia_vid_codec_mgr *mgr,
    unsigned pt,
