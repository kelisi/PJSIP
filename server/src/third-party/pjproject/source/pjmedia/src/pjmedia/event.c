...
PJ_DEF(pj_status_t)
pjmedia_event_mgr_create(pj_pool_t *pool,
                         unsigned options,
...
PJ_DEF(pjmedia_event_mgr *)
pjmedia_event_mgr_instance(void)
{
...
PJ_DEF(void)
pjmedia_event_init(pjmedia_event *event,
...
PJ_DEF(pj_status_t)
pjmedia_event_subscribe(pjmedia_event_mgr *mgr,
                        pjmedia_event_cb *cb,
                        void *user_data,
                        void *epub)
{
...
PJ_DEF(pj_status_t)
pjmedia_event_publish(pjmedia_event_mgr *mgr,
                      void *epub,
                      pjmedia_event *event,
