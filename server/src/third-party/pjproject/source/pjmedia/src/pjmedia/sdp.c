...
pjmedia_sdp_attr_create(pj_pool_t *pool,
                        const char *name,
...
PJ_DEF(pjmedia_sdp_attr *)
pjmedia_sdp_attr_clone(pj_pool_t *pool,
...
PJ_DEF(pj_status_t)
pjmedia_sdp_attr_add(unsigned *count,
...
PJ_DEF(unsigned)
pjmedia_sdp_attr_remove_all(unsigned *count,
                            pjmedia_sdp_attr *attr_array[],
                            const char *name)
{
...
PJ_DEF(pj_status_t)
pjmedia_sdp_attr_remove(unsigned *count,
                        pjmedia_sdp_attr *attr_array[],
                        pjmedia_sdp_attr *attr)
{
    unsigned i, removed = 0;
...
PJ_DEF(pj_status_t)
pjmedia_sdp_attr_get_fmtp(const pjmedia_sdp_attr *attr,
...
PJ_DEF(pjmedia_sdp_attr *)
pjmedia_sdp_attr_create_rtcp(pj_pool_t *pool,
                             const pj_sockaddr *a)
{
    enum
    {
...
PJ_DEF(pjmedia_sdp_attr *)
pjmedia_sdp_attr_create_ssrc(pj_pool_t *pool,
                             pj_uint32_t ssrc,
...
PJ_DEF(pj_status_t)
pjmedia_sdp_attr_to_rtpmap(pj_pool_t *pool,
...
pjmedia_sdp_conn_clone(pj_pool_t *pool,
...
PJ_DEF(pj_status_t)
pjmedia_sdp_media_add_attr(pjmedia_sdp_media *m,
                           pjmedia_sdp_attr *attr)
{
...
PJ_DEF(pj_status_t)
pjmedia_sdp_session_add_attr(pjmedia_sdp_session *s,
                             pjmedia_sdp_attr *attr)
{
 ...
 */
PJ_DEF(pj_status_t)
pjmedia_sdp_parse(pj_pool_t *pool,
                  char *buf, pj_size_t len,
 ...
 */
PJ_DEF(int)
pjmedia_sdp_print(const pjmedia_sdp_session *desc,
...
PJ_DEF(pj_status_t)
pjmedia_sdp_validate(const pjmedia_sdp_session *sdp)
{
...
/* Validate SDP session descriptor. */
PJ_DEF(pj_status_t)
pjmedia_sdp_validate2(const pjmedia_sdp_session *sdp,
                      pj_bool_t strict)
{
    unsigned i;
...
PJ_DEF(pj_status_t)
pjmedia_sdp_transport_cmp(const pj_str_t *t1,
                          const pj_str_t *t2)
{
 ...
 */
PJ_DEF(pj_uint32_t)
pjmedia_sdp_transport_get_proto(const pj_str_t *tp)
{
...
PJ_DEF(pj_status_t)
pjmedia_sdp_media_deactivate(pj_pool_t *pool,
                             pjmedia_sdp_media *m)
{
