 ...
 */
PJ_DEF(pj_status_t)
pjmedia_wav_player_port_create(pj_pool_t *pool,
                               const char *filename,
                               unsigned ptime,
                               unsigned options,
                               ...
                               pjmedia_port **p_port)
{
    ...
    fport->bytes_per_sample = (pj_uint16_t)(wave_hdr.fmt_hdr.bits_per_sample / 8);
 ...
 */
PJ_DEF(pj_status_t)
pjmedia_wav_player_port_set_pos(pjmedia_port *port,
                                pj_uint32_t bytes)
{
    struct file_reader_port *fport;
    pj_status_t status;
 ...
 */
PJ_DEF(pj_ssize_t)
pjmedia_wav_player_port_get_pos(pjmedia_port *port)
{
    struct file_reader_port *fport;
