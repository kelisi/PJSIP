...
PJ_DEF(pj_status_t)
pjmedia_jbuf_create(pj_pool_t *pool,
					const pj_str_t *name,
					unsigned frame_size,
					unsigned ptime,
					unsigned max_count,
...
PJ_DEF(pj_status_t)
pjmedia_jbuf_set_ptime(pjmedia_jbuf *jb,
					   unsigned ptime)
{
 ...
 */
PJ_DEF(pj_status_t)
pjmedia_jbuf_set_fixed(pjmedia_jbuf *jb,
					   unsigned prefetch)
{
	PJ_ASSERT_RETURN(jb, PJ_EINVAL);
 ...
 */
PJ_DEF(pj_status_t)
pjmedia_jbuf_set_adaptive(pjmedia_jbuf *jb,
						  unsigned prefetch,
...
PJ_DEF(pj_status_t)
pjmedia_jbuf_set_discard(pjmedia_jbuf *jb,
...
PJ_DEF(pj_status_t)
pjmedia_jbuf_reset(pjmedia_jbuf *jb)
{
	jb->jb_level = 0;
...
PJ_DEF(pj_status_t)
pjmedia_jbuf_destroy(pjmedia_jbuf *jb)
{
...
PJ_DEF(pj_bool_t)
pjmedia_jbuf_is_full(const pjmedia_jbuf *jb)
{
...
PJ_INLINE(void)
jbuf_update(pjmedia_jbuf *jb, int oper)
{
...
PJ_DEF(void)
pjmedia_jbuf_put_frame(pjmedia_jbuf *jb,
					   const void *frame,
...
PJ_DEF(void)
pjmedia_jbuf_put_frame2(pjmedia_jbuf *jb,
						const void *frame,
						pj_size_t frame_size,
						pj_uint32_t bit_info,
						int frame_seq,
...
PJ_DEF(void)
pjmedia_jbuf_put_frame3(pjmedia_jbuf *jb,
						const void *frame,
						pj_size_t frame_size,
						pj_uint32_t bit_info,
						int frame_seq,
 ...
 */
PJ_DEF(void)
pjmedia_jbuf_get_frame(pjmedia_jbuf *jb,
					   void *frame,
					   char *p_frame_type)
{
 ...
 */
PJ_DEF(void)
pjmedia_jbuf_get_frame2(pjmedia_jbuf *jb,
						void *frame,
						pj_size_t *size,
						char *p_frame_type,
						pj_uint32_t *bit_info)
 ...
 */
PJ_DEF(void)
pjmedia_jbuf_get_frame3(pjmedia_jbuf *jb,
						void *frame,
						pj_size_t *size,
						char *p_frame_type,
						pj_uint32_t *bit_info,
 ...
 */
PJ_DEF(pj_status_t)
pjmedia_jbuf_get_state(const pjmedia_jbuf *jb,
...
PJ_DEF(void)
pjmedia_jbuf_peek_frame(pjmedia_jbuf *jb,
						unsigned offset,
						const void **frame,
						pj_size_t *size,
						char *p_frm_type,
...
PJ_DEF(unsigned)
pjmedia_jbuf_remove_frame(pjmedia_jbuf *jb,
						  unsigned frame_cnt)
{
