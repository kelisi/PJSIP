...
pjmedia_format_copy(pjmedia_format *dst,
...
PJ_DEF(void)
pjmedia_format_init_video(pjmedia_format *fmt,
                          pj_uint32_t fmt_id,
                          unsigned width,
                          unsigned height,
                          unsigned fps_num,
...
PJ_DEF(pjmedia_video_format_mgr *)
pjmedia_video_format_mgr_instance(void)
{
...
PJ_DEF(void)
pjmedia_video_format_mgr_destroy(pjmedia_video_format_mgr *mgr)
{
    if (!mgr)
        mgr = pjmedia_video_format_mgr_instance();
