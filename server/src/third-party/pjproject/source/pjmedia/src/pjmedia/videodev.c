...
PJ_DEF(pjmedia_vid_subsys *)
pjmedia_get_vid_subsys(void)
{
    return &vid_subsys;
}
...
PJ_DEF(const char *)
pjmedia_vid_dev_cap_name(pjmedia_vid_dev_cap cap,
                         const char **p_desc)
{
    const char *desc;
    unsigned i;
...
/* API: init driver */
PJ_DEF(pj_status_t)
pjmedia_vid_driver_init(unsigned drv_idx,
                        pj_bool_t refresh)
{
...
/* API: deinit driver */
PJ_DEF(void)
pjmedia_vid_driver_deinit(unsigned drv_idx)
{
    pjmedia_vid_driver *drv = &vid_subsys.drv[drv_idx];
...
PJ_DEF(pj_status_t)
pjmedia_vid_dev_get_info(pjmedia_vid_dev_index id,
                         pjmedia_vid_dev_info *info)
{
    pjmedia_vid_dev_factory *f;
    unsigned index;
...
/* API: find device */
PJ_DEF(pj_status_t)
pjmedia_vid_dev_lookup(const char *drv_name,
                       const char *dev_name,
                       pjmedia_vid_dev_index *id)
{
...
PJ_DEF(pj_status_t)
pjmedia_vid_dev_stream_start(pjmedia_vid_dev_stream *strm)
{
    pj_status_t status;
...
/* API: Stop the stream. */
PJ_DEF(pj_status_t)
pjmedia_vid_dev_stream_stop(pjmedia_vid_dev_stream *strm)
{
