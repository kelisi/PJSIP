...
static void on_rx_rtp(pjmedia_tp_cb_param *param)
{
	...
	{
		PJ_LOG(3, (THIS_FILE, "[rtp][receive] on receive rtcp package "));
...

{
	...
	PJ_LOG(3, (THIS_FILE, "[media][stream] stream info ->rtcp interval:%d,\
		rtcp_bye_disable:%d,\
		cname:%s",
	...
	*/
	...
	/* Initially disable the VAD(Voice activity detection) in the stream, to help traverse NAT better */
