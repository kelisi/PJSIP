                                      ...
                                      pj_bool_t maintain_aspect_ratio)
{
    ...
    if (handle_rotation)
    {
        ...
        if (maintain_aspect_ratio)
        {
             ...
             */
            pj_size_t long_s = (conv->rot_size.h > conv->rot_size.w ? conv->rot_size.h : conv->rot_size.w);
            pj_size_t short_s = (conv->rot_size.h > conv->rot_size.w ? conv->rot_size.w : conv->rot_size.h);
